# Generated by Django 5.0.4 on 2024-08-14 06:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debt', models.DecimalField(decimal_places=3, max_digits=1000, verbose_name='Задолжность')),
                ('time_of_creation', models.DateTimeField(auto_now_add=True, verbose_name='Время создания')),
                ('supplier_retail_network', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.factory', verbose_name='Поставщик')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Пользватель')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('debt', models.DecimalField(decimal_places=3, max_digits=1000, verbose_name='Задолжность')),
                ('time_of_creation', models.DateTimeField(auto_now_add=True, verbose_name='Время создания')),
                ('supplier_factory', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.factory', verbose_name='Поставщик')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Пользватель')),
                ('supplier_retail_network', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.retailnetwork', verbose_name='Поставщик')),
            ],
            options={
